...
class HtmlReport(Plugin):
    ...
    encoding = 'UTF-8'
    report_file = None
    test_duration_time = datetime.resolution
    ...
    def addSuccess(self, test):
        ...
        time = datetime.now() - self.test_start_time
        self.test_duration_time = self.test_duration_time + time
        group.tests.append({
            'name': name[-1],
            'failed': False,
    ...
    def _format_output(self, o):
        if isinstance(o, str):
            ...
            return o
# self.startTime = str(datetime.now())[:19]
